#!/bin/bash
# Example script using rofi to prompt for productivity response
...
# Use rofi to ask if time was productive
RESPONSE=$(echo -e "working\nwasting\nstop (working)\nstop (wasting)" | rofi -dmenu -p "Was the time productive?" -theme-str 'window {width: 300px;}')
